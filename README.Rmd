...
These functions allow you to create a data visualization in a set theme instantly but are more fixed in some of their formatting. Examples of these functions can all be found later in this document
